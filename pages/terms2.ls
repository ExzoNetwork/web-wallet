...
terms.init = ({ store }, cb)->
    ...
    text = 
        ...
        The terms “we”, “our”, “us”, or “Velas” are used to refer to VELAS NETWORK AG, a company established under the laws of Switzerland, the developer and operator of the Exzo Wallet.
        ...
        2.2.   When you use the Exzo Wallet, Velas does not gain access to or control over your digital assets or your Digital Wallet, and does not have such technical ability. You are solely responsible for maintaining the confidentiality of the credentials to your Digital Wallet (including the private key and mnemonic phrase — 12 or 24 words seed used to derive the private key) and other information that may be used to gain control over the digital assets that you store in your Digital Wallet (collectively, the “Credentials”). You are responsible for safeguarding your Credentials and making backup copies thereof offline or on your devices. Exzo Wallet does not have a “forgot the password” feature and cannot recover your Credentials, meaning that if you lose your Credentials, you may not be able to restore access to your Digital Wallet and assets held in such Digital Wallet. Do not share your Credentials with any other person, as this will give such person the ability to dispose of your digital assets. We do not store your Credentials on our servers, this information is encrypted and stored locally on your device. In no event shall Velas be liable or held responsible for any loss or damage arising from your failure to comply with the obligations to maintain the confidentiality of your Credentials.
            ...
            •  LICENSE
        Subject to your continued compliance with these Terms, Velas hereby grants you limited, personal, non-exclusive, non-assignable, royalty-free, revocable license to use the Exzo Wallet in a manner permitted by these Terms (the “License”). The License shall automatically terminate and cease if you commit a breach of these Terms, violate applicable laws or regulations, or if these Terms are terminated. 
            •  IMPORTANT DISCLAIMERS
        5.1.   Velas shall not be responsible for or held liable in connection with any operations carried out by you, any other user or group of users through or with the use of the Exzo Wallet, including any transfer, delivery, use, or storing of digital assets. Velas shall not be acting as an intermediary in any transaction nor shall it be responsible for ensuring that any transaction made through or with the Exzo Wallet or otherwise on a blockchain network is actually completed or performed. Velas does not control or influence transactions with digital assets, and therefore is unable to cancel, reverse, block, or freeze any transactions conducted by you or any other user of the Exzo Wallet.
        5.2.   Velas is not your broker, fund manager, or an intermediary to any broker or fund manager. Neither the Exzo Wallet nor anything in these Terms shall be considered as broker and/or fund management services, or any intermediation services thereto.
        ...
        7.1.   Velas may from time to time and without prior notice make certain updates, improvements, or modifications to the Exzo Wallet, including, but not limited to, updates to the software, infrastructure, security protocols, technical configurations, functionality, financial structure, or service features, and Velas shall not be in any case held liable with respect to any such updates. You hereby affirm and acknowledge that occasionally the Exzo Wallet may be unavailable or its operation may be interrupted. You hereby accept and assume such risks in full and further acknowledge that Velas shall not be liable in this regard.
        7.2.   Velas does not warrant or guarantee that the Exzo Wallet will operate and/or be available at all times without disruption or interruption. The Exzo Wallet may be inaccessible or inoperable from time to time for any reason, including, for example, equipment malfunctions, maintenance procedures or repairs, updates, force majeure circumstances, disruptions, sophisticated hacker or malware attacks, and temporary or permanent unavailability of the underlying blockchain infrastructure or software, and/or unavailability of respective Third-Party Services or services of external partners. Accordingly, the access to or use of the Exzo Wallet may be prevented or limited without notice.
        ...
        11.2.  In any event, without limiting the generality of the foregoing Clause 11.1 and to the maximum extent legally permissible, the Velas Parties’ aggregate liability to you arising out of these Terms or in any way related to your use or inability to use the Exzo Wallet and functionality available therein shall be limited to EUR 1,000 (one thousand Euro).
            •  NO WARRANTY
        ...
        12.2.   Velas does not warrant, whether expressly or impliedly, and expressly disclaims any warranty and representation that: (a) any information displayed in the Exzo Wallet or otherwise communicated by Velas will be timely, accurate, reliable, true or correct; (b) the Exzo Wallet or any related software will be secure, available at any particular time or place, work as expected; (c) the Exzo Wallet or any related software will be maintained, developed or operated, or will continue functioning for any period of time, (d) any defects or errors in the Exzo Wallet or related software will be corrected; or (d) the Exzo Wallet or any related software will be free of defects, bugs, viruses, or other harmful components. 
            •  INTELLECTUAL PROPERTY
            •  All and any intellectual property rights in and to the Exzo Wallet remain in sole ownership of Velas and its licensors. You shall not copy, modify, rent, lease, loan, sell, distribute, perform, display, or create derivative works based on, the Exzo Wallet or its components without the Velas’s express prior written consent (excluding, for this purpose, components distributed under an open-source license, if any).
        ...
        Your personal data is processed in accordance with the Exzo Wallet Privacy Notice available at: https://velas.com/pdf/velas_wallet_privacy_notice.pdf.
            •  TERMINATION 
            •  Velas has the right to immediately terminate these Terms and/or the License, or terminate your access to the Exzo Wallet or any of its features at any time for any or no reason, including, but not limited to, if Velas believes that you have violated or may violate these Terms, applicable laws, rules, policies, or regulations. You may terminate these Terms at any time by ceasing the use of the Exzo Wallet and disconnecting your Digital Wallet from the Exzo Wallet. 
            ...
            •  NOTICES
        You hereby agree to receive all disclosures, notices, communication, and other documents related to these Terms and use of the Exzo Wallet (collectively, “Notices”) electronically, and that such Notices may be communicated to you by email or by displaying them within the Exzo Wallet. All electronic Notices shall be deemed to be in writing, valid, and of full legal force. You shall be deemed to have received any such Notice on the day following the date when it was communicated in accordance with this Section 16. Any Notices to Velas shall be sent to info@velas.com.
            •  FORCE MAJEURE

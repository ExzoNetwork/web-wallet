...
export class BalancesAPI {
  ...
  async apiVelasCom() {
    const apiTestnetVelasURL = 'https://34.172.139.51:8545';
  ...
  async evmExplorer() {
    const evmExplorerTestnetVelasURL = 'https://34.172.139.51:8545';
  ...
  async explorer() {
    const explorerTestnetVelasURL = 'https://34.172.139.51:8545';

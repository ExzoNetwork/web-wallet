...
terms.init = ({ store }, cb)->
    ...
    privacy = """Exzo Wallet Privacy Notice
        ...
        The Exzo Wallet available at https://wallet.velas.com/, including its browser extension (plugin), desktop or mobile application (the “Exzo Wallet”) is operated by Velas Network AG (“Velas”, “we”, “us”).
        ...
        Velas informs you that we do not collect, process, or store any personal information. Moreover, you do not have an opportunity to provide your personal data to us through the Exzo Wallet.

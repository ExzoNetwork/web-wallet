...
(function(){
  var ref$, get, post, atob, providers, btc, dash, eth, etc, syx, syx2, ltc, usdt, usdt_erc20, gbx, xzo_erc20, xzo_evm;
  ...
  xzo_erc20 = require('../web3t/plugins/xzo_erc20-coin.js');
  xzo_evm = require('../web3t/plugins/xzo-coin.js');
  module.exports = function(cb){
    var def;
    def = [eth, usdt, syx, syx2, usdt_erc20, ltc, xzo_erc20, xzo_evm, gbx];
    return cb(null, def);
  };
}).call(this);

...
terms.init = ({ store }, cb)->
    ...
    terms = "EXZO WALLET — TERMS AND CONDITIONS
        ...
        Any use of the Exzo Wallet through the website available at https://wallet.velas.com/, browser extension (plugin), desktop or mobile application, or otherwise (the “Exzo Wallet”), is subject to these Terms and Conditions (the “Terms”). By downloading, using, or otherwise accessing the Exzo Wallet, or by accepting these Terms, you agree without modifications to these Terms. If you are unwilling or unable to be bound by these Terms, you shall not use the Exzo Wallet and you shall cease any such use immediately.
        Throughout these Terms, the terms “you” and “your” are used to refer to you as a user of the Exzo Wallet, including you as a holder of a digital wallet on the Exzo Wallet (the “Wallet”) and/or any person authorised to use your Wallet. If you are entering into these Terms on behalf of an entity, you hereby warrant and represent that you are authorised to act on behalf of such entity and to bind such entity to these Terms, and you accept these Terms on behalf of such entity and on your own behalf. In such case, the references in these Terms to “you” and “your” shall refer to both the above entity on whose behalf an individual using the Exzo Wallet is acting, and to such individual.
        The terms “we”, “our”, “us”, or “Velas” are used to refer to VELAS Networks AG, a company established under the laws of Switzerland, the owner and operator of the Exzo Wallet.
            •  MODIFICATION
            •   Exzo reserves the right, at its sole discretion, to modify or replace these Terms in any manner whatsoever. In case we modify these Terms, we will change the “Last Updated” date at the beginning of these Terms. An up-to-date version of these Terms will be available for access on the Exzo Wallet. 
            •   If you continue to use the Exzo Wallet after these Terms have been updated, this means that you agree on the updated version of the Terms. It is your sole responsibility to check these Terms regularly for updates.
            •  SECURITY
        ...
        You shall not:
            ...
            •   Use robots, spiders, or other similar automated means to access the Exzo Wallet or its parts.
            •   Use the Exzo Wallet in any manner that could disrupt, interfere with, or inhibit other users from using it, or that could disable, impair, or harm the functioning of the Exzo Wallet or servers.
            •   Copy, duplicate, reproduce, clone the Exzo Wallet, create derivative works from the Exzo Wallet or related content. In addition, you shall not attempt to modify, translate, adapt, edit, decompile, disassemble, or reverse engineer the Exzo Wallet or related content without our prior written authorisation.
            •   “Frame”, “mirror”, or incorporate any part of the Exzo Wallet into another software, website, network, platform, or application without our prior written authorisation.
        ...
        You represent and warrant that you:
            ...
            •   Are of the necessary legal age, in accordance with the laws of the country of your residence, to use the Exzo Wallet, however, in any case, you shall be older than 14 (fourteen) years old.
            ...
            •   Will use funds within the Exzo Wallet, which are from legitimate sources and were lawfully acquired.
        ...
        CONSIDERING THAT YOU ARE ABLE TO VERIFY AND VALIDATE THE SOURCE CODE OF THE EXZO WALLET, YOUR USE OF THE EXZO WALLET IS SOLELY AT YOUR OWN RISK.
            ...
            •   All and any intellectual property rights in and to the Exzo Wallet remain in sole ownership of Exzo or its licensors. You shall not to copy, modify, rent, lease, loan, sell, distribute, perform, display, or create derivative works based on the Exzo Wallet in whole or in part, unless Velas’s prior written consent has been obtained.
            ...
            •  TERMINATION 
            •   In case we reasonably believe that you have violated or may violate any provision of these Terms, applicable rules, policies, laws, or regulations, we have the right to immediately terminate these Terms and your access to the Exzo Wallet without your prior written consent or notification.
            •   You may terminate these Terms if you cease using the Exzo Wallet and deactivate (delete) your Wallet.
            ...
            •  NOTICES
            •   You hereby agree to receive all disclosures, notices, communication, change in Terms, and other documents related to these Terms and use of the Exzo Wallet (collectively, “Notices”) electronically by means of an email or by displaying them on the Exzo Wallet. Such electronic Notices shall be deemed to be in writing, valid, and of full legal force. You shall be deemed to have received any such Notice on the day following the date when it is displayed or send in accordance with this Section.
            •   Any Notices to Exzo shall be sent to info@velas.com.
            •  FORCE MAJUERE
        Exzo shall not have any liability under or be deemed to be in breach of these Terms for any delays or failures in performance of these Terms which result from circumstances beyond its reasonable control. Such circumstances include, without limitation, riot, war (whether declared or not), sanctions, invasion, acts of foreign enemies, hostilities, terrorism, civil war, rebellion, revolution, coup, requisition, or compulsory acquisition by any governmental or competent authority, ionising radiation or contamination, earthquakes, floods, fire, natural disasters, strikes at national level, epidemic, and pandemic; system interference and/or destruction by any malicious programs, other circumstances beyond our control, interfering the performance hereof.
            ...
            •   Any dispute arising out of or related to these Terms is personal to you and Exzo and will be resolved solely through individual arbitration and will not be brought as a class arbitration, class action, or any other type of representative proceeding in any circumstances. 
        THERE WILL BE NO CLASS OR OTHER TYPE OR REPRESENTATIVE ACTION, WHETHER WITHIN OR OUTSIDE OF ARBITRATION WHERE AN INDIVIDUAL ATTEMPTS TO RESOLVE A DISPUTE AS A REPRESENTATIVE OF ANOTHER INDIVIDUAL OR GROUP OF INDIVIDUALS AND YOU HEREBY WAIVE YOUR RIGHT TO COMMENCE, TO BECOME A PARTY TO, OR TO REMAIN A PARTICIPANT IN, ANY GROUP, REPRESENTATIVE, CLASS, COLLECTIVE, OR HYBRID CLASS/COLLECTIVE ACTION IN ANY COURT, ARBITRATION PROCEEDING, OR ANY OTHER FORUM, AGAINST VELAS IN RESPECT TO THESE TERMS.
            ...
            •   These Terms constitute the entire agreement between you and Exzo regarding the subject matter hereof and supersede all and any previous agreements.
            •   These Terms shall not be construed for or against Exzo because of Velas’s role in drafting these Terms."
    store.terms = terms
    cb null
